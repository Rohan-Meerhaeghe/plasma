...
def fit_asymptotes(xdata,ydata,name,first_a_guess=1,first_b_guess=-2,second_a_guess=1,second_b_guess=2):
...
for data_set in data:
    fit_asymptotes(data_set.data[0],data_set.data[1],"langmuir_probe_p_" + data_set.pressure + "_i_" +data_set.current + ".png")